...
handleInputs :: (HasMany w [Player, Position, Velocity, Inputs, Camera, EntityCounter]) => Event -> System w ()
handleInputs e = do
...
handleEvent :: (HasMany w [Player, Velocity, Inputs, EntityCounter]) => Event -> System w ()
