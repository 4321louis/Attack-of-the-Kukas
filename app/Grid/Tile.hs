...
data Side = Water | LWater | RWater | Land | ThinLand | Moss | LLand | RLand deriving (Show,Read,Eq)
data Tile = Tile 
    { pic :: Picture
    , north :: Side 
    , east :: Side
...
connects Moss Moss = True
connects LLand RLand = True
connects RLand LLand = True
connects _ _ = False
